...
import Controle.ControleCadastroProdutosSalao;
 ...
 * @author: José Walter.
 */
public class FrmCadastroProdutosSalao extends javax.swing.JFrame {
   ...
   ControleCadastroProdutosSalao contrl = new ControleCadastroProdutosSalao();
  
    public FrmCadastroProdutosSalao() {
        initComponents();
        connsalao.conexao();
        preencherCombo();
        preencherTabela("SELECT * FROM tbl_cadastroprodutosalao "); 
        ...
        //-------------------------------------------------------------------------------------------------------
              ...
              Logger.getLogger(FrmCadastroProdutosSalao.class.getName()).log(Level.SEVERE, null, ex);
          }
...
//-------------------------------------------------------------------------------------------------------
    ...
    private void initComponents() {
        ...
        jTableSalao = new javax.swing.JTable();
        ...
        jTableSalao.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jTableSalao.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableSalaoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableSalao);
        ...
        jLabelIdCodigoProduto1.setText("Tela de apresentação do Cadastro de Produtos do Salão");
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        // Declaração do botão salvar do Formulário de Cadastro de Produtos do Salão :
           ...
           mod.setData_Pedido(jFormattedTextFieldDataPedido.getText());
           mod.setData_Entrega(jFormattedTextFieldDataEntrega.getText());
           mod.setQuantidade(jTextFieldQuantidade.getText());
           mod.setDescricao_Produto(jTextFieldDescricaoProduto.getText());
           mod.setPreco_Custo(jTextFieldPrecoCusto.getText());
           mod.setPreco_Venda(jTextFieldPrecoVenda.getText());
           mod.setCodigo_Barra(jTextFieldCodigoBarra.getText());
           mod.setNome_Fornecedor((String) jComboBoxNomeFornecedor.getSelectedItem());           

            contrl.InserirProdutoSalao(mod);
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        // Declaração do botão editar do Form Cadastro de Produtos do Salão:
           ...
           mod.setCodigo_Barra(jTextFieldCodigoBarra.getText());
           mod.setNome_Fornecedor((String) jComboBoxNomeFornecedor.getSelectedItem()); 
           mod.setId_ProdutoSalao(Integer.parseInt(jTextFieldIdProduto.getText()));

           contrl.EditarProdutoSalao(mod);
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        // Declaração do botão excluir do Formulário Cadastro de Produtos do Salão:
           ...
           contrl.ExcluirProdutoSalao(mod);
    ...
    private void jButtonFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFecharActionPerformed
        ...
        dispose();
        JOptionPane.showMessageDialog(null, "Deseja realmente sair do Cadastro de Produtos do Salão?");
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        // Declaração do botão primeiro referente ao botão editar do Formulario de Cadastro de Produtos do Salão:
           ...
           ModeloCadastroProdutosSalao modelo = contrl.BuscaProduto(mod);
            
             jTextFieldIdProduto.setText(String.valueOf(modelo.getId_ProdutoSalao()));
             jTextFieldPesquisar.requestFocus();
             jTextFieldNomeProduto.setText(modelo.getNome_Produto());
             jFormattedTextFieldDataPedido.setText(modelo.getData_Pedido());
             jFormattedTextFieldDataEntrega.setText(modelo.getData_Entrega());
             jTextFieldQuantidade.setText(String.valueOf(modelo.getQuantidade()));
             jTextFieldDescricaoProduto.setText(modelo.getDescricao_Produto());
             jTextFieldPrecoCusto.setText(String.valueOf(modelo.getPreco_Custo()));
             jTextFieldPrecoVenda.setText(String.valueOf(modelo.getPreco_Venda()));
             jTextFieldCodigoBarra.setText(modelo.getCodigo_Barra());
             jComboBoxNomeFornecedor.setSelectedItem(modelo.getNome_Fornecedor());
              ...
              // Declaração do código para Habiitar e desabilitar os botões após cricar em novo:
                 ...
                 jButtonNovo.setEnabled(false);
                  ...
                  preencherTabela("SELECT * FROM tbl_cadastroprodutosalao WHERE Nome_Produto like '%" + jTextFieldPesquisar.getText() + "%'");  
    ...
    private void jButtonCadastroFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastroFornecedorActionPerformed
        ...
        FrmCadastroFornecedoresSalao cadfor = new FrmCadastroFornecedoresSalao();
        cadfor.setVisible(true);
    }//GEN-LAST:event_jButtonCadastroFornecedorActionPerformed

    private void jTableSalaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableSalaoMouseClicked
        // Declaração do código de evento do mouse para ecolher um dos dados da tabela :
        
           String nomeProduto = ""+ jTableSalao.getValueAt(jTableSalao.getSelectedRow(), 0);
           connsalao.conexao();
       try {
           connsalao.executaSQL("SELECT * FROM tbl_cadastroprodutosalao WHERE Nome_Produto ='" + nomeProduto + "'");
           connsalao.rs.first();
           jTextFieldIdProduto.setText(String.valueOf(connsalao.rs.getInt("Id_ProdutoSalao")));
           jTextFieldNomeProduto.setText(connsalao.rs.getString("Nome_Produto"));
           jFormattedTextFieldDataPedido.setText(connsalao.rs.getString("Data_Pedido"));
           jFormattedTextFieldDataEntrega.setText(connsalao.rs.getString("Data_Entrega"));
           jTextFieldQuantidade.setText(connsalao.rs.getString("Quantidade"));
           jTextFieldDescricaoProduto.setText(connsalao.rs.getString("Descricao_Produto"));
           jTextFieldPrecoCusto.setText(connsalao.rs.getString("Preco_Custo"));
           jTextFieldPrecoVenda.setText(connsalao.rs.getString("Preco_Venda"));
           jTextFieldCodigoBarra.setText(connsalao.rs.getString("Codigo_Barra"));
              
              connpesquisa.executaSQL("SELECT * FROM tbl_cadastrofornecedoressalao WHERE Id_FornecedorSalao ="+connsalao.rs.getInt("Id_FornecedorSalao") );
    ...
    }//GEN-LAST:event_jTableSalaoMouseClicked
...
//------------------------------------------------------------------------------------------------------------------------
    ...
    public void preencherCombo(){
      ...
      try {
          connsalao.conexao();
          connsalao.executaSQL("SELECT * FROM tbl_cadastrofornecedoressalao ORDER BY Id_FornecedorSalao");
          connsalao.rs.first();
          jComboBoxNomeFornecedor.removeAllItems();
        do{
          jComboBoxNomeFornecedor.addItem(connsalao.rs.getString("Nome_Fornecedor"));
          }while(connsalao.rs.next());
          connsalao.desconecta();
       } catch (Exception ex) {
 ...
 public void preencherTabela(String SQL){
         ...
         ArrayList dados = new ArrayList();
          ...
          String [] Colunas = new String [] { "Nome do Produto", "Quantidade", "Preço do Produto"  };
              connsalao.conexao();
             try {
                 connsalao.executaSQL(SQL);
                 connsalao.rs.first();
                  do{
                    dados.add(new Object[]{connsalao.rs.getString("Nome_Produto"),
                    connsalao.rs.getString("Quantidade"), connsalao.rs.getString("Preco_Venda")});
                 }while(connsalao.rs.next());   
             } catch (Exception ex) {
               ...
               jTableSalao.setModel(modelo);
               jTableSalao.getColumnModel().getColumn(0).setPreferredWidth(350);
               jTableSalao.getColumnModel().getColumn(0).setResizable(false);
               jTableSalao.getColumnModel().getColumn(1).setPreferredWidth(100);
               jTableSalao.getColumnModel().getColumn(1).setResizable(false); 
               jTableSalao.getColumnModel().getColumn(2).setPreferredWidth(200);
               jTableSalao.getColumnModel().getColumn(2).setResizable(false); 
               jTableSalao.getTableHeader().setReorderingAllowed(false);
               jTableSalao.setAutoResizeMode( jTableSalao.AUTO_RESIZE_OFF);
               jTableSalao.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
...
//===========================================================================================================   
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCadastroProdutosSalao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FrmCadastroProdutosSalao().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTableSalao;
