...
import Controle.ControleContasPagarLoja;
 ...
 * @author: José Walter.
 */
public class FrmContasPagarLoja extends javax.swing.JFrame {
    ClassConectaBanco conncontas = new ClassConectaBanco();
    ModeloContasPagarLoja mod = new ModeloContasPagarLoja();
    ControleContasPagarLoja contrl = new ControleContasPagarLoja();

    public FrmContasPagarLoja() {
        initComponents();  
        conncontas.conexao();        
        preencherComboFornecedorLoja();
        preencherTabela("SELECT * FROM tbl_contasapagarloja  ORDER BY Id_ContasLoja");
...
//-------------------------------------------------------------------------------------------------------
         ...
         try {
              ...
              Logger.getLogger(FrmContasPagarLoja.class.getName()).log(Level.SEVERE, null, ex);
          }
...
//------------------------------------------------------------------------------------------------------- 
    ...
    private void initComponents() {
        ...
        setTitle("Controle de Contas a Pagar da Loja");
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(51, 102, 255));
        jLabel1.setText("Apresentação da tela de Contas a pagar da Loja");
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        // Declaração do botão novo do Formulário Contas a Pagar Loja:
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        // Declaração do botão salvar do Formulário Contas a Pagar Loja:
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        // Declaração do botão editar do Formulario de Contas a pagar Loja:
    ...
    private void jButtonFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFecharActionPerformed
        // Declaração do  Código do botão fechar do Formulario de Contas a Pagar Loja:
        
        dispose();
        JOptionPane.showMessageDialog(null, "Deseja realmente sair do Formulário Contas a Pagar Loja?");
    ...
    private void jButtonPrimeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrimeiroActionPerformed
        ...
        try {
            conncontas.executaSQL("SELECT * FROM tbl_contasapagarloja ORDER BY Id_ContasLoja");
            conncontas.rs.first();
            jTextFieldCodigoConta.setText(String.valueOf(conncontas.rs.getInt("Id_ContasLoja")));
         ...
         ArrayList dados = new ArrayList();
          ...
          "Valor Total", "Juros", "Multa"};
             ...
             try {
                 ...
                 conncontas.rs.first();
                  do{
                    dados.add(new Object[]{conncontas.rs.getInt("Id_ContasLoja"),
...
//===========================================================================================================
    ...
    public void preencherComboFornecedorLoja(){
      
        conncontas.conexao();
        try {
            conncontas.executaSQL("SELECT * FROM tbl_cadastrofornecedoresloja ORDER BY Id_FornecedorLoja");
            conncontas.rs.first();
...
//============================================================================================================ 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmContasPagarLoja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FrmContasPagarLoja().setVisible(true);
            }
        });
    }
