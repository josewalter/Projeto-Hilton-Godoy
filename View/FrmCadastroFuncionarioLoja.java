...
import Controle.ControleCadastroFuncionarioLoja;
 ...
 * @author: José Walter.
 */
public class FrmCadastroFuncionarioLoja extends javax.swing.JFrame {
   ClassConectaBanco connfuncionarioloja = new ClassConectaBanco();
   ModeloCadastroFuncionarioLoja mod = new ModeloCadastroFuncionarioLoja();
   ControleCadastroFuncionarioLoja funcionarioloja = new ControleCadastroFuncionarioLoja();
   
    public FrmCadastroFuncionarioLoja() {
        initComponents();
        connfuncionarioloja.conexao();
...
//-------------------------------------------------------------------------------------------------------------        
         ...
         try {
              ...
              Logger.getLogger(FrmCadastroFuncionarioLoja.class.getName()).log(Level.SEVERE, null, ex);
          }
...
//---------------------------------------------------------------------------------------------------------------
         ...
         preencherTabela("SELECT * FROM tbl_cadastrofuncionarioloja  ORDER BY Id_FuncionarioLoja");
    }
 ...
 //--------------------------------------------------------------------------------------------------------------   
    ...
    private void initComponents() {
        ...
        jTableFuncionarioLoja = new javax.swing.JTable();
        ...
        jTextFieldNomeFuncionarioLoja = new javax.swing.JTextField();
        jLabelNomeFuncionarioLoja = new javax.swing.JLabel();
        ...
        setTitle("Cadastro de Funcionários da Loja");
        setResizable(false);
        ...
        jTableFuncionarioLoja.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane1.setViewportView(jTableFuncionarioLoja);
        ...
        jTextFieldNomeFuncionarioLoja.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jTextFieldNomeFuncionarioLoja.setEnabled(false);

        jLabelNomeFuncionarioLoja.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelNomeFuncionarioLoja.setForeground(new java.awt.Color(51, 102, 255));
        jLabelNomeFuncionarioLoja.setText("Nome do Funcionário da Loja");
                    ...
                    .addGroup(jPanelPrincipalLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelPrincipalLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabelNomeFuncionarioLoja)
                                    .addComponent(jTextFieldNomeFuncionarioLoja, javax.swing.GroupLayout.PREFERRED_SIZE, 517, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanelPrincipalLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanelPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(jTextFieldNomeFuncionarioLoja, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel1.setText("Apresentação da tela de Cadastro de Funcionário da Loja");
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        ...
        jTextFieldNomeFuncionarioLoja.setText("");
        ...
        jTextFieldNomeFuncionarioLoja.setEnabled(true);
        jTextFieldNomeFuncionarioLoja.requestFocus();
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        mod.setNomeFuncionarioLoja(jTextFieldNomeFuncionarioLoja.getText());
        ...
        funcionarioloja.SalvarDados(mod);
       preencherTabela("SELECT * FROM tbl_cadastrofuncionarioloja  ORDER BY Id_FuncionarioLoja");
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        mod.setFacebook(jTextFieldfacebook.getText());
        mod.setTwitter(jTextFieldTwitter.getText());
        mod.setIdFuncionarioLoja(Integer.parseInt(jTextFieldIdFuncionario.getText()));
       
        funcionarioloja.EditarDados(mod);
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        funcionarioloja.ExcluirDados(mod);
    ...
    private void jButtonFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFecharActionPerformed
        // Declaração do  Código do botão fechar do Form Cadastro de funcionário da loja:
        dispose();
        JOptionPane.showMessageDialog(null, "Deseja realmente sair do Cadastro de Funcionario da Loja?");
    ...
    private void jButtonPrimeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrimeiroActionPerformed
        ...
        try {
            connfuncionarioloja.executaSQL("SELECT * FROM tbl_cadastrofuncionarioloja  ORDER BY Id_FuncionarioLoja");
            connfuncionarioloja.rs.first();

            jTextFieldIdFuncionario.setText(String.valueOf(connfuncionarioloja.rs.getInt("Id_FuncionarioLoja")));
            jTextFieldNomeFuncionarioLoja.setText(connfuncionarioloja.rs.getString("Nome_Funcionario"));
            jFormattedTextFieldDataEntrada.setText(connfuncionarioloja.rs.getString("Data_Entrada"));
            jFormattedTextFieldDataSaida.setText(connfuncionarioloja.rs.getString("Data_Saida"));
            jTextFieldEndereco.setText(connfuncionarioloja.rs.getString("Endereco"));
            jTextFieldCidade.setText(connfuncionarioloja.rs.getString("Cidade"));
            jComboBoxEstado.setSelectedItem(connfuncionarioloja.rs.getString("Estado"));
            jFormattedTextFieldCep.setText(connfuncionarioloja.rs.getString("Cep"));
            jFormattedTextFieldCpf.setText(connfuncionarioloja.rs.getString("Cpf"));
            jFormattedTextFieldRg.setText(connfuncionarioloja.rs.getString("Rg"));
            jFormattedTextFieldTelefoneResidencial.setText(connfuncionarioloja.rs.getString("Telefone_Residencial"));
            jFormattedTextFieldCelularContato.setText(connfuncionarioloja.rs.getString("Celular_Contato"));
            jTextFieldEmail.setText(connfuncionarioloja.rs.getString("Email"));
            jTextFieldfacebook.setText(connfuncionarioloja.rs.getString("Facebook"));
            jTextFieldTwitter.setText(connfuncionarioloja.rs.getString("Twitter"));
    ...
    private void jButtonAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAnteriorActionPerformed
        ...
        try {
            //  connclientesalao.executaSQL("SELECT * FROM tbl_cadastroclientesalao ORDER BY Id_ClienteSalao");
            connfuncionarioloja.rs.previous();
 ...
 public void preencherTabela(String SQL){
         ...
         ArrayList dados = new ArrayList();
          ...
          String [] Colunas = new String [] { "Id_FuncionarioLoja", "Nome_Funcionario", "Data_Entrada", "Data_Saida",
          "Endereco", "Cidade", "Estado", "Cep", "Cpf", "Rg", "Telefone_Residencial", "Celular_Contato",
          "Email", "Facebook", "Twitter" };
                     
             try {
                 connfuncionarioloja.executaSQL(SQL);
                 connfuncionarioloja.rs.first();
                  do{
                    dados.add(new Object[]{connfuncionarioloja.rs.getInt("Id_FuncionarioLoja"),
                    connfuncionarioloja.rs.getString("Nome_Funcionario"), connfuncionarioloja.rs.getString("Data_Entrada"), 
                    connfuncionarioloja.rs.getString("Data_Saida"),connfuncionarioloja.rs.getString("Endereco"),
                    connfuncionarioloja.rs.getString("Cidade"), connfuncionarioloja.rs.getString("Estado"), 
                    connfuncionarioloja.rs.getString("Cep"), connfuncionarioloja.rs.getString("Cpf"), 
                    connfuncionarioloja.rs.getString("Rg"), connfuncionarioloja.rs.getString("Telefone_Residencial"),
                    connfuncionarioloja.rs.getString("Celular_Contato"), connfuncionarioloja.rs.getString("Email"),
                    connfuncionarioloja.rs.getString("Facebook"), connfuncionarioloja.rs.getString("Twitter")});
                 }while(connfuncionarioloja.rs.next());   
             } catch (Exception ex) {
                 JOptionPane.showMessageDialog(null, "Erro ao preencher o ArrayList!\n Erro: " + ex);
             }
             
                ModeloTabela modelo = new ModeloTabela(dados, Colunas);
               jTableFuncionarioLoja.setModel(modelo);
               jTableFuncionarioLoja.getColumnModel().getColumn(0).setPreferredWidth(130);
               jTableFuncionarioLoja.getColumnModel().getColumn(0).setResizable(false);
               jTableFuncionarioLoja.getColumnModel().getColumn(1).setPreferredWidth(180);
               jTableFuncionarioLoja.getColumnModel().getColumn(1).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(2).setPreferredWidth(100);
               jTableFuncionarioLoja.getColumnModel().getColumn(2).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(3).setPreferredWidth(130);
               jTableFuncionarioLoja.getColumnModel().getColumn(3).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(4).setPreferredWidth(180);
               jTableFuncionarioLoja.getColumnModel().getColumn(4).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(5).setPreferredWidth(100);
               jTableFuncionarioLoja.getColumnModel().getColumn(5).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(6).setPreferredWidth(100);
               jTableFuncionarioLoja.getColumnModel().getColumn(6).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(7).setPreferredWidth(120);
               jTableFuncionarioLoja.getColumnModel().getColumn(7).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(8).setPreferredWidth(120);
               jTableFuncionarioLoja.getColumnModel().getColumn(8).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(9).setPreferredWidth(120);
               jTableFuncionarioLoja.getColumnModel().getColumn(9).setResizable(false);
               jTableFuncionarioLoja.getColumnModel().getColumn(10).setPreferredWidth(100);
               jTableFuncionarioLoja.getColumnModel().getColumn(10).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(11).setPreferredWidth(100);
               jTableFuncionarioLoja.getColumnModel().getColumn(11).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(12).setPreferredWidth(200);
               jTableFuncionarioLoja.getColumnModel().getColumn(12).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(13).setPreferredWidth(200);
               jTableFuncionarioLoja.getColumnModel().getColumn(13).setResizable(false); 
               jTableFuncionarioLoja.getColumnModel().getColumn(14).setPreferredWidth(200);
               jTableFuncionarioLoja.getColumnModel().getColumn(14).setResizable(false);
               jTableFuncionarioLoja.getTableHeader().setReorderingAllowed(false);
               jTableFuncionarioLoja.setAutoResizeMode( jTableFuncionarioLoja.AUTO_RESIZE_OFF);
               jTableFuncionarioLoja.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCadastroFuncionarioLoja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FrmCadastroFuncionarioLoja().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabelNomeFuncionarioLoja;
    ...
    private javax.swing.JTable jTableFuncionarioLoja;
    private javax.swing.JTextField jTextFieldCidade;
    private javax.swing.JTextField jTextFieldEmail;
    private javax.swing.JTextField jTextFieldEndereco;
    private javax.swing.JTextField jTextFieldIdFuncionario;
    private javax.swing.JTextField jTextFieldNomeFuncionarioLoja;
