 ...
 * @author: José Walter.
 */
public class FrmPesquisaVendasSalao extends javax.swing.JFrame {
    ClassConectaBanco connpesquisar = new ClassConectaBanco();
    
    public FrmPesquisaVendasSalao() {
        initComponents();
 ...
 //-------------------------------------------------------------------------------------------------------
        ...
        try {
           ...
           jFormattedTextFieldData.setFormatterFactory(new DefaultFormatterFactory(form));
              ...
              Logger.getLogger(FrmPesquisaVendasSalao.class.getName()).log(Level.SEVERE, null, ex);
          }
...
//-------------------------------------------------------------------------------------------------------
    ...
    private void initComponents() {
        ...
        jTableVendasRealizadasSalao = new javax.swing.JTable();
        ...
        jTableDetalhesVendasSalao = new javax.swing.JTable();
        ...
        setTitle("Pesquisa de Vendas do Salão");
        setResizable(false);
        ...
        jTableVendasRealizadasSalao.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jTableVendasRealizadasSalao.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableVendasRealizadasSalaoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableVendasRealizadasSalao);
        ...
        jTableDetalhesVendasSalao.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane2.setViewportView(jTableDetalhesVendasSalao);
        ...
        jLabel1.setText("Apresentação da tela de Pesquisa de Vendas do Salão");
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        // Declaração do código para realizar a pesquisa de produtos vendidos:
           ...
           preencherTabelaVendasRealizadasLoja("SELECT * FROM tbl_vendassalao inner join tbl_cadastroclientesalao"
    ...
    private void jTableVendasRealizadasSalaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableVendasRealizadasSalaoMouseClicked
        // Declaração do código para lançar os produtos vendidos na tabela Detalhes da venda:
           int cod;
            cod = (int) jTableVendasRealizadasSalao.getValueAt(jTableVendasRealizadasSalao.getSelectedRow(),0);
             
           preencherTabelaDetalhesVendaLoja("SELECT * FROM tbl_vendassalao INNER JOIN tbl_itens_vendaprodutossalao "
           + " ON tbl_vendassalao.Id_VendaSalao = tbl_itens_vendaprodutossalao.Id_VendaSalao "
           + " INNER JOIN tbl_cadastroprodutosalao ON tbl_itens_vendaprodutossalao.Id_ProdutoSalao = "
           + " tbl_cadastroprodutosalao.Id_ProdutoSalao WHERE tbl_vendassalao.Id_VendaSalao =" + cod );   
    }//GEN-LAST:event_jTableVendasRealizadasSalaoMouseClicked
    ...
    private void jButtonFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFecharActionPerformed
        ...
        dispose();
        JOptionPane.showMessageDialog(null, "Deseja realmente sair do formulário Pesquisa de Vendas do Salão ?");
    ...
    private void jButtonRelatorioVendasRealizadasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRelatorioVendasRealizadasActionPerformed
        // Declaração do codigo para chamar o relatório de vendas do Salão :

        try {
            connpesquisar.executaSQL(" SELECT tbl_vendassalao.`Id_VendaSalao` AS tbl_vendassalao_Id_VendaSalao, "
            ...
            JasperPrint jpPrint = JasperFillManager.fillReport("C:\\Users\\Pc\\Documents\\NetBeansProjects\\Projetos de Clientes\\ProjtHiltonGodoy\\src\\Relatorios\\RelatorioVendasSalao.jasper", new HashMap(), relatResult);
          ...
          String [] Colunas = new String [] { "Código da Venda", "Data da Venda", "Valor da Venda", "Cliente"};
             ...
             try {
                 ...
                 connpesquisar.rs.first();
                  do{
                    dados.add(new Object[]{connpesquisar.rs.getInt("Id_VendaSalao"),
               ...
               jTableVendasRealizadasSalao.setModel(modelo);
               jTableVendasRealizadasSalao.getColumnModel().getColumn(0).setPreferredWidth(130);
               jTableVendasRealizadasSalao.getColumnModel().getColumn(0).setResizable(false);
               jTableVendasRealizadasSalao.getColumnModel().getColumn(1).setPreferredWidth(180);
               jTableVendasRealizadasSalao.getColumnModel().getColumn(1).setResizable(false); 
               jTableVendasRealizadasSalao.getColumnModel().getColumn(2).setPreferredWidth(100);
               jTableVendasRealizadasSalao.getColumnModel().getColumn(2).setResizable(false); 
               jTableVendasRealizadasSalao.getColumnModel().getColumn(3).setPreferredWidth(300);
               jTableVendasRealizadasSalao.getColumnModel().getColumn(3).setResizable(false); 
               jTableVendasRealizadasSalao.getTableHeader().setReorderingAllowed(false);
               jTableVendasRealizadasSalao.setAutoResizeMode( jTableVendasRealizadasSalao.AUTO_RESIZE_OFF);
               jTableVendasRealizadasSalao.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
...
//====================================================================================================
         ...
         ArrayList dados = new ArrayList();
          ...
          String [] Colunas = new String [] { "Produtos", "Quantidade" };
             ...
             try {
                ...
                ModeloTabela modelo = new ModeloTabela(dados, Colunas);
               jTableDetalhesVendasSalao.setModel(modelo);
               jTableDetalhesVendasSalao.getColumnModel().getColumn(0).setPreferredWidth(230);
               jTableDetalhesVendasSalao.getColumnModel().getColumn(0).setResizable(false);
               jTableDetalhesVendasSalao.getColumnModel().getColumn(1).setPreferredWidth(180);
               jTableDetalhesVendasSalao.getColumnModel().getColumn(1).setResizable(false);
               jTableDetalhesVendasSalao.getTableHeader().setReorderingAllowed(false);
               jTableDetalhesVendasSalao.setAutoResizeMode( jTableDetalhesVendasSalao.AUTO_RESIZE_OFF);
               jTableDetalhesVendasSalao.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPesquisaVendasSalao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FrmPesquisaVendasSalao().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTableDetalhesVendasSalao;
    private javax.swing.JTable jTableVendasRealizadasSalao;
