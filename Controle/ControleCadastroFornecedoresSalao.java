 ...
 * @author: José Walter.
 */
public class ControleCadastroFornecedoresSalao {
    ClassConectaBanco connfornecedor = new ClassConectaBanco();
    
    //=======================================================================================================================    
   // Código do botão Salvar usando modelo MVC.
    
    public void SalvarDados(ModeloCadastroFornecedoresSalao mod){
       
        connfornecedor.conexao();
        try {
            PreparedStatement pst = connfornecedor.conn.prepareStatement("INSERT INTO tbl_cadastrofornecedoressalao ("
...
//================================================================================================================ 
    ...
    public void EditarDados(ModeloCadastroFornecedoresSalao mod){
       
        connfornecedor.conexao();
        try {
            PreparedStatement pst = connfornecedor.conn.prepareStatement("UPDATE tbl_cadastrofornecedoressalao "
...
//=================================================================================================    
    ...
    public void ExcluirDados(ModeloCadastroFornecedoresSalao mod){
      connfornecedor.conexao();
      try {
           PreparedStatement pst = connfornecedor.conn.prepareStatement("DELETE FROM tbl_cadastrofornecedoressalao WHERE Id_FornecedorSalao =?");
